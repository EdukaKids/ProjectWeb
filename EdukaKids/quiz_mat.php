...
<div class="contenedor2">
		<div class="contenedor_tarjeta">
			<a href="/quiz_adicao/quiz.php">
				<figure id="tarjeta">
					<img src="images/adicao.png" class="frontal" alt="quiz" title="Eduka Kids">
					<figcaption class="trasera">
						<h2 class="titulo">Adição</h2>
						<hr>
						<p>Continhas</p>
					</figcaption>
				</figure>
    ...
    <div class="contenedor_tarjeta">
      <a href="/quiz_seq/quiz.php">
        <figure id="tarjeta">
          <img src="images/seq.png" class="frontal" alt="jogos" title="Eduka Kids">
          <figcaption class="trasera">
            <h2 class="titulo">Sequência</h2>
            <hr>
            <p>Sequência Númericas </p>
          </figcaption>
        </figure>
      </a>
    </div>
    ...
    <div class="contenedor_tarjeta">
      <a href="">
        <figure id="tarjeta">
          <img src="images/quant.png" class="frontal" alt="videos" title="Eduka Kids">
          <figcaption class="trasera">
            <h2 class="titulo">Quantidade</h2>
            <hr>
            <p>Quantidade de objetos</p>
          </figcaption>
        </figure>
      </a>
    </div>
