...
<div class="contenedor2">
		<div class="contenedor_tarjeta">
			<a href="quiz_mat.php">
				<figure id="tarjeta">
					<img src="images/mat.png" class="frontal" alt="quiz" title="Eduka Kids">
					<figcaption class="trasera">
						<h2 class="titulo">Matemática</h2>
						<hr>
						<p>Contas, Sequências numéricas</p>
					</figcaption>
				</figure>
			</a>
		</div>
    ...
    <div class="contenedor_tarjeta">
      <a href="jogos.php">
        <figure id="tarjeta">
          <img src="images/por.png" class="frontal" alt="jogos" title="Eduka Kids">
          <figcaption class="trasera">
    ...
    <div class="contenedor_tarjeta">
      <a href="">
        <figure id="tarjeta">
          <img src="images/ing.png" class="frontal" alt="videos" title="Eduka Kids">
          <figcaption class="trasera">
            <h2 class="titulo">Inglês</h2>
            <hr>
            <p>Cores, Números, Frutas</p>
          </figcaption>
        </figure>
      </a>
    </div>
